...
public class RecipeActivity extends AppCompatActivity {
    ...
    public void gotoShare(View view) {
        TextView recipeName = (TextView) findViewById(R.id.txt_recipeName);
        String recipeText = "Nama resep : " + recipeName.getText().toString();
        TextView recipeAuthor = (TextView) findViewById(R.id.txt_recipeAuthor);
        String authorText = "Penulis resep : " + recipeAuthor.getText().toString();
        TextView recipeCountry = (TextView) findViewById(R.id.txt_recipeCountry);
        String countryText = "Asal Negara : " + recipeCountry.getText().toString();
        TextView recipeIngredients = (TextView) findViewById(R.id.txt_recipeIngredients);
        String ingredientsText = "Bahan : " + recipeIngredients.getText().toString();
        TextView recipeDescription = (TextView) findViewById(R.id.txt_recipeDescription);
        String descriptionText = "Deskripsi : " + recipeDescription.getText().toString();
        TextView recipeHowTo= (TextView) findViewById(R.id.txt_recipeHowto);
        String howtoText = "Cara Membuat: " + recipeHowTo.getText().toString();

        String message = recipeText + "\n" + authorText + "\n" + countryText + "\n" + ingredientsText + "\n" + descriptionText + "\n" + howtoText ;
